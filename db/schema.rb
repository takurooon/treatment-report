...
ActiveRecord::Schema.define(version: 2019_10_08_130813) do
  ...
  create_table "female_shikkans", force: :cascade do |t|
    t.bigint "clinic_report_id", null: false
    t.bigint "female_disease_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clinic_report_id"], name: "index_female_shikkans_on_clinic_report_id"
    t.index ["female_disease_id"], name: "index_female_shikkans_on_female_disease_id"
  end
  ...
  create_table "female_syujutsus", force: :cascade do |t|
    t.bigint "clinic_report_id", null: false
    t.bigint "female_surgery_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "hairan_yokuseis", force: :cascade do |t|
    t.bigint "clinic_report_id", null: false
    t.bigint "ovulation_inhibitor_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clinic_report_id"], name: "index_hairan_yokuseis_on_clinic_report_id"
    t.index ["ovulation_inhibitor_id"], name: "index_hairan_yokuseis_on_ovulation_inhibitor_id"
  end

  create_table "hairan_yuhatsus", force: :cascade do |t|
    t.bigint "clinic_report_id", null: false
    t.bigint "ovulation_inducer_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clinic_report_id"], name: "index_hairan_yuhatsus_on_clinic_report_id"
    t.index ["ovulation_inducer_id"], name: "index_hairan_yuhatsus_on_ovulation_inducer_id"
  end
  ...
  create_table "male_shikkans", force: :cascade do |t|
    t.bigint "clinic_report_id", null: false
    t.bigint "male_disease_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clinic_report_id"], name: "index_male_shikkans_on_clinic_report_id"
    t.index ["male_disease_id"], name: "index_male_shikkans_on_male_disease_id"
  end
  ...
  create_table "male_syujutsus", force: :cascade do |t|
    t.bigint "clinic_report_id", null: false
    t.bigint "male_surgery_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clinic_report_id"], name: "index_male_syujutsus_on_clinic_report_id"
    t.index ["male_surgery_id"], name: "index_male_syujutsus_on_male_surgery_id"
  end
  ...
  create_table "ranso_shigekis", force: :cascade do |t|
    t.bigint "clinic_report_id", null: false
    t.bigint "ovarian_stimulant_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["clinic_report_id"], name: "index_ranso_shigekis_on_clinic_report_id"
    t.index ["ovarian_stimulant_id"], name: "index_ranso_shigekis_on_ovarian_stimulant_id"
  end
  ...
  add_foreign_key "female_shikkans", "clinic_reports"
  ...
  add_foreign_key "hairan_yokuseis", "clinic_reports"
  add_foreign_key "hairan_yokuseis", "ovulation_inhibitors"
  add_foreign_key "hairan_yuhatsus", "clinic_reports"
  add_foreign_key "hairan_yuhatsus", "ovulation_inducers"
  ...
  add_foreign_key "male_shikkans", "male_diseases"
  add_foreign_key "male_syujutsus", "clinic_reports"
  add_foreign_key "male_syujutsus", "male_surgeries"
  add_foreign_key "ranso_shigekis", "clinic_reports"
  add_foreign_key "ranso_shigekis", "ovarian_stimulants"
